...
from app.routers import auth, children, tasks, rewards, games, interact, reports, dashboard
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://kiddymate.com"],
...
app.include_router(tasks.router, prefix="/children", tags=["Tasks"])
